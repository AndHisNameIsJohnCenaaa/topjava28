...
public class MealTestData {
    ...
    public static final LocalDateTime END_DATE_TIME = of(2020, Month.JANUARY, 30, 21, 0);
    public static final String REST_URL_FILTER = REST_URL + "/filter?" +
            "startDate=" + START_DATE_TIME.toLocalDate().toString() +
            "&endDate=" + END_DATE_TIME.toLocalDate().toString() +
            "&startTime=" + START_DATE_TIME.toLocalTime().toString() +
            "&endTime=" + END_DATE_TIME.toLocalTime().toString();
    ...
    public static final List<Meal> mealsWithoutMeal1 = List.of(meal7, meal6, meal5, meal4, meal3, meal2);
