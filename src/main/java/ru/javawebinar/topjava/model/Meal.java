...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BETWEEN_DATE_TIME_SORTED, query =
                "SELECT m FROM Meal m WHERE m.user.id =:user_id AND m.dateTime >=:start AND m.dateTime <:end ORDER BY m.dateTime DESC")
})
@Entity
@Table(name = "meals")
public class Meal extends AbstractBaseEntity {
    ...
    public static final String BETWEEN_DATE_TIME_SORTED = "Meal.getBetweenDateTime";
